...
extension TouchstoneFile {
    ...
    public func serialized(comment: String = "Touchstone file generated by AntScopeKit") -> String {
        var output = "! \(comment)\n"
    ...
    public func write(to url: URL, comment: String = "Touchstone file generated by AntScopeKit") throws {
